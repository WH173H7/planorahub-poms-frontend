...
{label:'Communication',items:[{label:'Messenger',href:'/internal-chat',icon:'chat'},{label:'Email',href:'/email',icon:'email'},{label:'Official Letters',href:'/letterhead',icon:'letter'},{label:'Shared Files',href:'/shared-files',icon:'file'}]}
];
