...
{label:'Sales',items:[{label:'Leads',icon:'leads',disabled:true},{label:'Prospects',icon:'prospects',disabled:true},{label:'Clients',icon:'clients',disabled:true},{label:'Organizations',icon:'organizations',disabled:true},{label:'Contacts',icon:'contacts',disabled:true}]},
...
{label:'Team',items:[{label:'Staff',icon:'staff',disabled:true}]},{label:'Communication',items:[{label:'Email',icon:'email',disabled:true},{label:'WhatsApp',icon:'whatsapp',disabled:true}]},
